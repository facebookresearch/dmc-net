...
parser.add_argument('--arch_d', type=str, default="Discriminator",
...
parser.add_argument('--lr-adv-g', default=1, type=float,
                    help='adv loss weight during training G.')
parser.add_argument('--lr-adv-d', default=1, type=float,
                    help='adv loss weight during training D.')
...
parser.add_argument('--lr_d_mult', default=0.01, type=float, help='discriminator learning multiplier.')
