...
class MFNET_3D(nn.Module):
    ...
    def __init__(self, num_classes, pretrained=False, modality = 'rgb', **kwargs):
        ...
        if modality == 'rgb':
            ...
            raise ValueError('Invalid Modality input: %s', modality)
        print(modality,'-----------------------')   
        self.conv1 = nn.Sequential(OrderedDict([
                    ('conv', nn.Conv3d(input_channel, conv1_num_out, kernel_size=(3,5,5), padding=(1,2,2), stride=(1,2,2), bias=False)),
