...
parser.add_argument('--log-file', type=str, default="./eval-ucf101-split1_96_flow_add_drop.log",
                    help="set logging file.")
...
if __name__ == '__main__':
    ...
    val_sampler = sampler.RandomSampling(num=args.clip_length,
                                         ...
                                         speed=[1.0, 1.0])
    val_loader = VideoIter(video_prefix='/UCF101/TSN_input/', # change this part accordingly
                      txt_list=os.path.join(data_root, 'raw', 'list_cvt', 'testlist0{}.txt'.format(args.split)), 
                      sampler=val_sampler,
                      force_color=True,
                      ...
                      name='test',
                      cached_info_path = os.path.join(data_root, 'raw',  'list_cvt', 'ucf101_split{}_test_info.txt'.format(args.split)),
