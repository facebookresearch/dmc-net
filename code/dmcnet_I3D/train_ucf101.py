...
parser.add_argument('--lr-base', type=float, default=0.005,
                    help="learning rate")
parser.add_argument('--lr-base2', type=float, default=0.001,
                    help="learning rate for stage 2")
parser.add_argument('--lr-d', type=float, default=None,
                    help="learning rate for discriminator")
parser.add_argument('--lr-steps', type=list, default=[int(1e5*x) for x in [0.5, 0.7, 1.0, 4, 5]],
                    help="number of samples to pass before changing learning rate") # 1e6 million
#parser.add_argument('--lr-steps', type=list, default=[int(1e4*x) for x in [12, 18, 24, 30, 40, 60]],
#                    help="number of samples to pass before changing learning rate") # 1e6 million
