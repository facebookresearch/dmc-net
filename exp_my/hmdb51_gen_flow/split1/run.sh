...
# exp/hmdb51_gen_flow/split1/run.sh; ./exp/hmdb51_gen_flow/split1/run_combine.sh 2>&1 | tee ./exp/hmdb51_gen_flow/split1/acc.log
...
python train.py \
	...
	--weights ./exp/hmdb51_coviar/flow/split1/_flow_model_best.pth.tar \
