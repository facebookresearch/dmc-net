...
# exp/hmdb51_gan/split2/run.sh; ./exp/hmdb51_gan/split2/run_combine.sh 2>&1 | tee ./exp/hmdb51_gan/split2/acc.log
...
python train.py \
	...
	--weights exp/hmdb51_gen_flow/split2/_mv_model_best.pth.tar \
