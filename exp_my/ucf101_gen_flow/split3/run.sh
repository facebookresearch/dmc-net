...
# exp/ucf101_gen_flow/split3/run.sh; ./exp/ucf101_gen_flow/split3/run_combine.sh 2>&1 | tee ./exp/ucf101_gen_flow/split3/acc.log
...
python train.py \
	...
	--train-list /projects/LSDE/work03/FB/data_preprocess/datalists/ucf101_split3_train.txt \
	--test-list /projects/LSDE/work03/FB/data_preprocess/datalists/ucf101_split3_test.txt \
	--weights ./exp/ucf101_coviar/ucf101_flow/split3/_flow_model_best.pth.tar \
