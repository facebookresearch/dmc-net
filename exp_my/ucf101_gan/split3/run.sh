...
expdir=ucf101_gan/split3
representation=mv

# exp/ucf101_gan/split3/run.sh; ./exp/ucf101_gan/split3/run_combine.sh 2>&1 | tee ./exp/ucf101_gan/split3/acc.log
...
python train.py \
	...
	--weights exp/ucf101_gen_flow/split3/_mv_model_best.pth.tar \
