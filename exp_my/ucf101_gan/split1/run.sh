...
# exp/ucf101_gan/split1/run.sh; ./exp/ucf101_gan/split1/run_combine.sh 2>&1 | tee ./exp/ucf101_gan/split1/acc.log
...
python train.py \
	...
	--weights exp/ucf101_gen_flow/split1/_mv_model_best.pth.tar \
